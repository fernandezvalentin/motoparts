...
export function Dashboard({ onNavegar }) {
  ...
  return (
    <div className="dashboard">
      ...
      <div className="dashboard-layout-vertical" style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
        {/* Alertas de Stock */}
                ...
                <tbody>
                  {stats.alertasStock.map((item, index) => (
                    <tr key={item.id} style={{ animationDelay: `${index * 50}ms`, animation: "fadeInUp 300ms var(--ease-out) backwards" }}>
                      ...
                      <td data-label="REPUESTO" className="td-truncate">
        ...
        {/* Bottom Sections: Top Vendidos & Proveedores */}
